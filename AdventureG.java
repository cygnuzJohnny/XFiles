...
public class AdventureG {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome! What is your name?"); //Identify game player
		name = sc.nextLine();
		System.out.println();

		System.out.println("Would you like to play a game? (y/n)"); //Prompt user to play game?
		choice = sc.nextLine();
		System.out.println();
		...
		if (choice.equalsIgnoreCase("y")) { 
			...
			if (choice.equalsIgnoreCase("face the beast")) {
				...
				if (choice.equalsIgnoreCase("3")) {
					...
					if (choice.equalsIgnoreCase("bow and arrow")) { //Player choose weapon
						System.out.println(
